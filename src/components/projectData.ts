...
export const ProjectData: ProjectInterface[] = [
    {
        ...
        img: SnowElbrusImg,
        title: 'SnowElbrus',
        skills: ['HTML', 'CSS', 'JavaScript', 'Sanity CMS', 'SEO Optimization', 'Splide.js'],
        description: 'A modern ski instructor website designed for lesson booking on Elbrus. Developed as a custom project for a client. Includes responsive UI, interactive image gallery with Splide.js, pricing cards, and quick booking via Telegram and Google Forms. Integrated with Sanity CMS for convenient content management. Built with a focus on performance, accessibility, and SEO.',
